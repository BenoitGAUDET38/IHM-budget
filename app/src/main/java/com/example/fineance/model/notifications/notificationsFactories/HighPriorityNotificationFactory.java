...
public class HighPriorityNotificationFactory extends AbstractNotificationFactory {
    ...
    public BasicNotification buildBasicNotification(Context context, String title, String message) {
        return new BasicNotification(context, NotificationCompat.PRIORITY_HIGH, title, message);
    }
    ...
    public ImageNotification buildImageNotification(Context context, Resources resources, int idImage, String title, String message) {
        return new ImageNotification(context, resources, idImage, NotificationCompat.PRIORITY_HIGH, title, message);
    }
}
