...
public class LowPriorityNotificationFactory extends AbstractNotificationFactory {
    ...
    public BasicNotification buildBasicNotification(Context applicationContext, Context currentContext, String title, String message) {
        return new BasicNotification(applicationContext, currentContext, NotificationCompat.PRIORITY_LOW, title, message);
    }
    ...
    public ImageNotification buildImageNotification(Context applicationContext, Context currentContext, Resources resources, String title, String message) {
        return new ImageNotification(applicationContext, currentContext, resources, NotificationCompat.PRIORITY_LOW, title, message);
    }
}
